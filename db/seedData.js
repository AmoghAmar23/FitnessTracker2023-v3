...
// const { } = require('./');
const { createUser, createActivity, createRoutine, getRoutinesWithoutActivities, getAllActivities, addActivityToRoutine } = require("./index")
const client = require("./client")

async function dropTables() {
  try {
  console.log("Dropping All Tables...")
    // await client.query('DROP DATABASE IF EXISTS fitness-dev;');
    // await client.query('CREATE DATABASE fitness-dev;');
  ...
  console.log("table hasnt dropped",err)
}
}
